...
from code.Const import COLOR_BLUE, COLOR_WHITE, WIN_HEIGHT, MENU_OPTION, EVENT_ENEMY, SPAWN_TIME, COLOR_GREEN, \
    COLOR_ORANGE, EVENT_TIMEOUT, TIMEOUT_STEP, TIMEOUT_LEVEL
