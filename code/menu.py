...
class Menu:
    ...
    def run(self, ):
        ...
        while True:
            ...
            self.menu_text(text_size=50, text="Fun",COLOR_ORANGE, text_center_pos=((WIN_WIDTH / 2), 70))
            self.menu_text(text_size=50, text="Mountain",COLOR_ORANGE, text_center_pos=((WIN_WIDTH / 2), 120))
